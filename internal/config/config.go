...
type Config struct {
	...
	GRPCServerAddress string `yaml:"grpc_server_address" json:"grpc_server_address" env:"GRPC_SERVER_ADDRESS" env-default:":50051"`
...
func flagParse(conf *Config) error {
	...
	flag.StringVar(&conf.GRPCServerAddress, "g", "", "gRPC server address")
