...
func (m *MockUrlRepository) SaveURLBatch(ctx context.Context, urls []model.URL) error {
	m.ctrl.T.Helper()
...
func (mr *MockUrlRepositoryMockRecorder) SaveURLBatch(ctx, urls any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SaveURLBatch", reflect.TypeOf((*MockUrlRepository)(nil).SaveURLBatch), ctx, urls)
}
